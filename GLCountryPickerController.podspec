Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/ghostlordstar/EMCCountryPickerController-DialingCodes"
  s.license      = { :type => "BSD", :file => "LICENSE" }
  s.author             = { "ghostlordstar" => "https://ghostlordstar.github.io" }
  s.platform     = :ios, "6.1"
  s.source       = { :git => "https://github.com/ghostlordstar/EMCCountryPickerController-DialingCodes.git", :tag => "1.5.0" }

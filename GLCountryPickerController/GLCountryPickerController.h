...
#import "GLCountryDelegate.h"

@interface GLCountryPickerController : UIViewController
...
/** 代理 */
@property (weak, nonatomic) id<GLCountryDelegate> countryDelegate;

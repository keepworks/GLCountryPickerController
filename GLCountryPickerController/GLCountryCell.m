...
/** 国家模型 */
@property (strong, nonatomic) GLCountry *country;

/** 时区 */
@property (strong, nonatomic) NSLocale *displayLocale;
@end

@implementation GLCountryCell
...
- (void)updateDataWithModel:(GLCountry *)country displayLocale:(NSLocale *)locale {
    ...
    if (country) {
        ...
        NSString *imagePath = [NSString stringWithFormat:@"GLCountryPickerController.bundle/%@", self.country.countryCode];
